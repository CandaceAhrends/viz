...
export const NEWS_API_URI = 'http://localhost:7007/news';
export const STOCK_API_URI = 'http://localhost:7007/agg';
export const CONFIG_SCANNER_URI = 'http://localhost:8909/pubconfig';
export const POLY_DETAIL_URI = 'http://localhost:7007/detail';
export const POLY_TICKER_URI = 'http://localhost:7007/ticker';
